...
//    public static String[] TREAND_ID_LIST = {"T1","T2","T3"};
    ...
    public Game(Game game) {
        ...
        this.PlayerName = game.PlayerName.clone();

        this.currentSeason = game.currentSeason;

        this.currentStartPlayer = game.currentStartPlayer;

        this.gameBoard = new Board(game.gameBoard);

        this.gameResource = game.gameResource.clone();
        this.gameResource[0] = new GameResources(game.gameResource[0]);
        this.gameResource[1] = new GameResources(game.gameResource[1]);

        this.gameState = game.gameState;

        this.timerThread = game.timerThread;
    }
...
//    }
    ...
    public String getBoardInformation() {
        ...
        sbuf.append("/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_//_/_/_/_/_/_/_/\n");
        sbuf.append("1 ゼミの配置状況\n");
        sbuf.append("1-1:"+this.gameBoard.getWorkersOnBoard().get("1-1")+"\n");
