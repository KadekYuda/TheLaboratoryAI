...
public class Board {
    ...
    public Board(Board board) {
      this.boardState = new HashMap<>(board.boardState.size());
      for(String entry: board.boardState.keySet()) {
        this.boardState.put(entry, board.boardState.get(entry));
      }

      this.SeminorWorkers = new ArrayList<>(board.SeminorWorkers.size());
      for(String workers : board.SeminorWorkers) {
        this.SeminorWorkers.add(workers);

      }
      
      this.machineEnable = board.machineEnable.clone();
    }
